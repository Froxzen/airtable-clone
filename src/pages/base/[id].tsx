      ...
      <div className="flex flex-1">
        ...
        <div className="w-64 flex-shrink-0 border-r border-gray-200 bg-gray-50 p-3">
          ...
          <div className="mb-4">
            ...
            {/* Only grid view tabs here, no grid view+ */}
            {/* Main Grid View (no plus, tick if selected) - always show */}
            {gridViewsData && gridViewsData.length > 0 && (
              <div
                key={gridViewsData[0]?.id}
                ...
                onClick={() =>
                  gridViewsData[0] && handleSelectGridView(gridViewsData[0].id)
                }
              >
                <div className="flex items-center gap-2">
                  <Grid3X3 className="h-4 w-4" />
                  <span>{gridViewsData[0]?.name}</span>
                </div>
                {selectedGridViewId === gridViewsData[0]?.id && (
          ...
          <div>
            ...
            <div className="space-y-1">
              {/* GridViewTabsBar now only renders the grid view+ button here */}
              <GridViewTabsBar
                gridViews={[]}
